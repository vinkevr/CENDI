<main>
    <form action=""method="POST">
        ...
        <div data-paso="2">
            ...
            <input type="number" name="noext">
            </div>
            <div>
            <label for="noint">NO. INT:  </label>
            <input type="number" name="noint">
            </div>
            <div>
            ...
            <input type="number" name="noempleado">
            </div>
            <div>
            ...
            <input type="time" name="hortrabajo">
            </div>
            <div>
            <label for="extencionDE">EXTENCION:  </label>
            <input type="number" name="extencionDE">
            </div>
        </div>
        <div data-paso="3">
